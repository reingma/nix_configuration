    ...
    settings = {
      "plugin:hyprbars" = {
        ...
        hyprbars-button =
          ...
          [
            # Red close button
            "rgb(${config.colorScheme.palette.base0F}),12,,${closeAction}"
            # Yellow "minimize" (send to special workspace) button
            "rgb(${config.colorScheme.palette.base0E}),12,,${minimizeAction}"
      ...
      bind =
        ...
        in
        [ "SUPERSHIFT,m,exec,${barsEnabled} && ${toggleOff} || ${toggleOn}" ];
    };
  };
}
